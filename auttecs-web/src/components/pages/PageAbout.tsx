    ...
    <div className="relative w-full h-full flex items-center overflow-y-auto page-scroll bg-[#050505]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 pt-20 sm:pt-24 pb-10 w-full relative">
        ...
        >
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black text-white tracking-tight px-2">
            Work for you is our{" "}
        ...
        <div className="grid sm:grid-cols-2 gap-3 sm:gap-4 mb-6 sm:mb-8">
          {[
            ...
            <motion.div
              ...
              className="card-hover p-4 sm:p-6 rounded-2xl border border-[#1e1e1e] bg-[#0d0d0d] flex gap-3 sm:gap-4"
            >
              ...
              <div>
                <h3 className="text-white text-lg sm:text-xl font-black mb-1 sm:mb-2">{item.title}</h3>
        ...
        <motion.div
          ...
          className="mb-6 sm:mb-8 p-4 sm:p-6 rounded-2xl border border-[#f5a623]/15 bg-[#f5a623]/5 text-center"
        >
        ...
        <div className="grid grid-cols-3 sm:grid-cols-3 lg:grid-cols-5 gap-2 sm:gap-3">
          {values.map((v, i) => (
            <motion.div
              ...
              className="card-hover p-3 sm:p-4 rounded-2xl border border-[#1e1e1e] bg-[#0d0d0d] text-center group"
            >
              <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-xl mx-auto mb-1.5 sm:mb-2 flex items-center justify-center group-hover:scale-110 transition-transform"
              ...
              <h4 className="text-white font-bold text-[10px] sm:text-xs mb-0.5 sm:mb-1 leading-tight">{v.name}</h4>
